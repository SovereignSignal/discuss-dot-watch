...
export const FORUM_CATEGORIES: ForumCategory[] = [
  {
    ...
    forums: [
      ...
      // GitHub Discussions — Crypto
      {
        ...
        tier: 1,
        sourceType: 'github',
        sourceId: 'github-ethereum-eips',
      },
      {
        name: 'Ethereum PM',
        url: 'https://github.com/ethereum/pm/discussions',
        description: 'Ethereum project management and ACD calls',
        logoUrl: 'https://github.com/ethereum.png',
        tier: 2,
        sourceType: 'github',
        sourceId: 'github-ethereum-pm',
      },
      {
        name: 'Foundry',
