...
import { RefreshCw, Clock, CheckCircle, XCircle, Loader2, Trash2, CheckCheck, MessageSquare } from 'lucide-react';
...
export function DiscussionFeed({
  ...
  return (
    <section className="flex-1 flex flex-col" aria-label="Discussion feed">
      {/* Header */}
      <header className="px-5 sm:px-6 pt-6 pb-4 flex-shrink-0">
