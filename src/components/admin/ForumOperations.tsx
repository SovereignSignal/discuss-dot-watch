...
import { RefreshCw, Play, Pause, RotateCcw, Loader2, Search, Plus, Globe, Eye, EyeOff, ExternalLink, Check, AlertTriangle, ChevronDown, ChevronUp, ArrowRight, Upload, X, UserPlus, Trash2, Pencil, Save, Palette, Database, Users } from 'lucide-react';
import Link from 'next/link';
import { ConfirmDialog } from '@/components/ConfirmDialog';
import { FORUM_CATEGORIES, type ForumPreset } from '@/lib/forumPresets';
...
export function ForumAnalyticsSection({ getAuthHeaders, isDark = true }: { getAuthHeaders: () => Promise<Record<string, string>>; isDark?: boolean }) {
